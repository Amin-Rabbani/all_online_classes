...
class block_all_online_classes extends block_list {
    
    function init() {
        $this->title = get_string('all_online_classes', 'block_all_online_classes');
    }
    ...
    function get_content() {
        ...
        $this->content->footer = get_string('no_class', 'block_all_online_classes');
        return $this->content;
    }
